...
import { useAdaptiveSheetHeight } from "./feature_sheet/adaptive_sheet_height";
...
export function FeatureSheet({ feature, onClose, getDebugInfoSetters }) {
  ...
  const height = useMemo(() => Math.floor(0.95 * viewportHeight), [viewportHeight]);
  ...
  //useAdaptiveSheetHeight(setHeight, dY);
